...
<div class="bg-primary-dark" style="background-image: url({{asset('images/general/banner6.png')}}); background-size: cover  ; background-repeat: no-repeat ">
        <div class="content content-full text-center">
            ...
            <h1 class="h2 text-white mb-0">Create Location</h1>
            ...
            <div class="row push">
                <div class="col-lg-4">
                    <p class="fs-sm text-muted">
                        Here you can create a new Location.
                    </p>
                </div>
                <div class="col-lg-8 col-xl-5">
                    {!! Form::open(['method'=>'POST', 'action'=>['App\Http\Controllers\AdminLocationController@store'],
                        'files'=>false])
                   !!}
                    ...
                    <div class="form-group mb-4">
                        ...
                        {!! Form::text('google_calendar_id',null,['class'=>'form-control']) !!}
                    </div>
                    @endcan
