...
<div class="bg-image" style="background-image: url('http://localhost/backend_template/public/media/photos/photo10@2x.jpg');">
    <div class="bg-primary-dark-op">
        <div class="content content-full text-center">
            ...
            <h1 class="h2 text-white mb-0">Edit Faq</h1>
...
<div class="content content-boxed">
    ...
    <div class="block block-rounded">
        <div class="block-header block-header-default">
            <h3 class="block-title">Edit Faq</h3>
        </div>
        <div class="block-content">
            <div class="row push">
                    {!! Form::open(['method'=>'PATCH', 'action'=>['App\Http\Controllers\AdminFaqController@update',$faq->id],'files'=>false])!!}
                    ...
                    <div class="form-group  mb-4">
                        ...
                        {!! Form::textarea('answer', $faq->answer,['class'=>'form-control','id'=>'js-ckeditor5-classic']) !!}
                        @error('answer')
                        <p class="text-danger mt-2"> {{ $message }}</p>
                        @enderror
                    </div>
