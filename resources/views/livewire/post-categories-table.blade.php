<div class="block block-rounded">
    <div class="block-header block-header-default">
        ...
        <a href="{{route('postcategories.archive')}}">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <button class="btn btn-sm btn-alt-secondary" data-bs-toggle="tooltip" title="Archive Category" wire:click="archivePostCategory({{$postcategory->id}})"><i class="fa fa-archive"></i></button>
                            </div>
                        </td>
                        <!-- Modal -->
