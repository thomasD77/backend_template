...
{{--                   type="text" class="form-control form-control-alt" id="example-group3-input3-alt2" name="category" placeholder="New Category">--}}
{{--            <button  type="submit" class="btn btn-secondary">--}}
{{--                Submit--}}
{{--            </button>--}}
{{--        </div>--}}
{{--    </form>--}}
    {!! Form::open(['method'=>'POST', 'action'=>['App\Http\Controllers\AdminPostCategoryController@store'],'files'=>false])!!}
    <div class="d-flex">
